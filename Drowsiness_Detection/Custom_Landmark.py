...
def plot_landmark(img_, facial_area_obj):    
...
while True:
    ...
    for facial_area in facial_areas.keys():
        facial_area_obj = facial_areas['Lips']
        
        plot_landmark(results, facial_area_obj)

        facial_area_obj_left_eye = facial_areas['Left_eye']
        plot_landmark(results, facial_area_obj_left_eye)

        facial_area_obj_right_eye = facial_areas['Right_eye']
        plot_landmark(results, facial_area_obj_right_eye)
